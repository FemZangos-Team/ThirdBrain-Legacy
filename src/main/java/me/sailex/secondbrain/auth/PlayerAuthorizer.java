...
public class PlayerAuthorizer {
     ...
     * @return true when the source satisfies the version-appropriate operator check
     */
     ...
     * @return true when the player satisfies the version-appropriate operator check
     */
